...
class DifferSyntaxAnalyzerFullTest {
    ...
    fun testFullSyntaxAnalyzer() {
        val syntaxAnalyzer = DifferFactory.createSyntaxAnalyzer("Программа Метод Эйлера; Коэффициенты a = 10; b = 50; Интервал 0, 50; Шаг 0.6; Значения x11 = 10; x22 = 43; Уравнения dxdt1 = 2+3; dxdt2 = 5+6; Конец",
        ...
        assertEquals(6, tree.childs.count())
        ...
        val equationTree = tree.childs.first { tree -> val token = tree.token; token is KeywordToken && token.keywordType == KeywordType.Equation }
